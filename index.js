...
console.log('Rock, Paper, Scissors...', game('rock', computer));
...
console.log('kilo to miles:',miles(5));
...
console.log('centimeters to feet', feet(100));
...
console.log(`sing bottles of soda on the wall:, ${annoyingSong(4)}`);
